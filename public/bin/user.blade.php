...
<body>
    ...
    <div class="navbar">
        <div class="navContentWrapper">
            ...
            <div class="nav_text">
                <a href="{{ route('home') }}" class="pages @if (request()->is('/')) active @endif">Home</a>
                <a href="{{ route('about') }}" class="pages @if (request()->is('about')) active @endif">About
                    Us</a>
                <a href="{{ route('portfolio') }}" class="pages @if (request()->is('/portfolio')) active @endif">Portfolio</a>
